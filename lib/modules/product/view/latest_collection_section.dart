...
import 'package:campconnectus_marketplace/modules/product/controller/latest_collection_controller.dart';
import 'package:campconnectus_marketplace/modules/product/widgets/star_row.dart';

class LatestCollectionSection extends StatelessWidget {
  const LatestCollectionSection({super.key});

  @override
  Widget build(BuildContext context) {
    final controller = Get.put(LatestCollectionController());
          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                GestureDetector(
                  onTap: () {
                    Get.toNamed(AppRoutes.latestCollectionView);
                  },
                  child: Text(
                    'View All'.tr,
