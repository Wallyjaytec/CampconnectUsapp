        ...
        children: [
          Row(
            children: [
              ...
              TextButton(onPressed: () {}, child: Text('View All'.tr)),
            ],
          ),
          ...
          Expanded(
            child: ClipRRect(
              ...
              child: CachedNetworkImage(
                imageUrl: p.imageUrl, fit: BoxFit.cover, width: double.infinity,
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: Container(
        ...
        child: const Column(children: [Expanded(child: ShimmerBox(borderRadius: 10)), SizedBox(height: 8), ShimmerBox(height: 12, borderRadius: 6), SizedBox(height: 8)]),
      ),
    );
  }
}
