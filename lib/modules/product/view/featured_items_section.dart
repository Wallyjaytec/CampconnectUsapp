...
import 'package:campconnectus_marketplace/modules/product/controller/featured_products_controller.dart';
...
class FeaturedItemsSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final controller = Get.put(FeaturedProductsController());
          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                GestureDetector(
                  onTap: () {
                    Get.toNamed(AppRoutes.featuredItemsView);
                  },
                  child: Text(
                    'View All'.tr,
