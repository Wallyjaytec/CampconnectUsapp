...
class _SplashScreenState extends State<SplashScreen> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    try {
      ...
      Get.snackbar('Animation Error', e.toString(), backgroundColor: Colors.red);
    }
    ...
    Timer(const Duration(seconds: 3), () {
      try {
        ...
        Get.snackbar('Navigation Error', e.toString(), backgroundColor: Colors.red);
        // Fallback navigation
      ...
      body: Center(
        child: AnimatedBuilder(
          ...
          builder: (context, child) => Transform.translate(
            ...
            child: Opacity(opacity: _fadeAnimation?.value ?? 1, child: child),
          ),
          child: SizedBox(width: 160, height: 160, child: ClipRRect(
