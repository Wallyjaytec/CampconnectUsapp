...
import 'package:campconnectus_marketplace/modules/account/view/my_order_list_view.dart';
import 'package:campconnectus_marketplace/modules/account/view/my_wallet_view.dart';
...
import 'package:campconnectus_marketplace/modules/onboarding/view/currency_select_view.dart';
import 'package:campconnectus_marketplace/modules/onboarding/view/language_select_view.dart';
import 'package:campconnectus_marketplace/modules/product/view/discount_sales_view.dart';
import 'package:campconnectus_marketplace/modules/product/view/featured_items_view.dart';
import 'package:campconnectus_marketplace/modules/product/view/following_products_view.dart';
import 'package:campconnectus_marketplace/modules/product/view/guest_checkout_view.dart';
import 'package:campconnectus_marketplace/modules/product/view/guest_order_summary_view.dart';
import 'package:campconnectus_marketplace/modules/product/view/latest_collection_view.dart';
import 'package:campconnectus_marketplace/modules/product/view/new_product_list_view.dart';
import 'package:campconnectus_marketplace/modules/product/view/order_summary_view.dart';
import 'package:campconnectus_marketplace/modules/product/view/popular_items_view.dart';
import 'package:campconnectus_marketplace/modules/product/view/product_filter_view.dart';
import 'package:campconnectus_marketplace/modules/product/view/recently_viewed_view.dart';
...
class AppPages {
  ...
  static final pages = [
    ...
    GetPage(name: AppRoutes.cartView, page: () => const CartView()),
    GetPage(
    ...
    GetPage(name: AppRoutes.myWalletView, page: () => MyWalletView()),
    GetPage(
    ...
    GetPage(name: AppRoutes.faqView, page: () => const FaqView()),
    GetPage(
